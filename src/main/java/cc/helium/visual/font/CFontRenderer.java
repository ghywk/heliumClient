...
public class CFontRenderer extends FontRenderer {
    ...
    public static String getFormatFromString(String p_78282_0_) {
        ...
        while ((var2 = p_78282_0_.indexOf(167, var2 + 1)) != -1) {
            ...
            if (CFontRenderer.isFormatColor(var4)) {
                var1 = new StringBuilder("\u00a7" + var4);
                continue;
            }
            if (!CFontRenderer.isFormatSpecial(var4)) continue;
            ...
            switch (var8) {
                ...
                case '\u00a7': {
                    ...
                    if ((var9 = str.charAt(++var5)) != 'l' && var9 != 'L') {
                        if (var9 != 'r' && var9 != 'R' && !CFontRenderer.isFormatColor(var9)) break;
                        var7 = false;
                        break;
                    }
                    var7 = true;
    ...
    public void setFont(Font font, boolean antiAlias, int charOffset) {
        ...
        synchronized (CFontRenderer) {
            this.font = new CFont(font, antiAlias, charOffset);
            this.boldFont = new CFont(font.deriveFont(1), antiAlias, charOffset);
            this.italicFont = new CFont(font.deriveFont(2), antiAlias, charOffset);
            this.boldItalicFont = new CFont(font.deriveFont(3), antiAlias, charOffset);
            this.FONT_HEIGHT = this.getHeight();
        }
    }
    ...
    protected String wrapFormattedStringToWidth(String str, int wrapWidth) {
        ...
        String var7 = CFontRenderer.getFormatFromString(var4) + str.substring(var3 + (var6 ? 1 : 0));
